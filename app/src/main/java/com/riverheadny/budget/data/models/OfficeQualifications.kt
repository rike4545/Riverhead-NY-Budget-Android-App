 ...
 *
 * Mirrors web/lib/office-qualifications.ts.
 */

data class OfficeRequirement(
    val label: String,
    val value: String,
    val detail: String,
    val source: String,
...
data class ElectorTest(
    val label: String,
    val detail: String,
)

data class CodeDecision(
    val what: String,
    val detail: String,
    val source: String,
)

object OfficeQualifications {

    val electedRequirements = listOf(
        OfficeRequirement(
            label = "Age",
            value = "18 or older",
    ...
    const val ELECTOR_TITLE = "What \"elector of the Town\" actually means"
    const val ELECTOR_LEDE =
    ...
    val electorTests = listOf(
        ElectorTest("Citizenship", "A citizen of the United States."),
        ElectorTest("Age", "Eighteen or older on the day of the election — not on the day of filing or of taking office."),
        ElectorTest(
            "Residency, and its length",
    ...
    const val ELECTOR_DISQUALIFIED =
    ...
    const val ELECTOR_SOURCES =
        "Election Law §§ 5-102, 5-106; \"residence\" defined at Election Law § 1-104(22)"

    const val NOT_REQUIRED_TITLE = "What the law does not require"

    val notRequired = listOf(
    ...
    const val NOT_REQUIRED_CLOSING =
    ...
    const val TERM_LIMIT_TITLE = "Riverhead limits terms — and said why"
    const val TERM_LIMIT_ADOPTED = "Adopted April 19, 2016 · Local Law No. 14-2016, codified at Town Code §§ 103-24 through 103-29"
    const val TERM_LIMIT_INTENT =
    ...
    const val TERM_LIMIT_MECHANICS =
    ...
    const val TERM_LIMIT_AUTHORITY =
        "Adopted under Municipal Home Rule Law § 10(1)(ii)a(1), expressly superseding Town Law § 24, which imposes no term limit."

    const val ELECTED_OFFICES_TITLE = "Which offices Riverhead elects"
    const val ELECTED_OFFICES_LEDE =
    ...
    const val ODD_YEAR_TITLE = "The Town's own election-timing law, and the case that overtook it"

    val oddYearBody = listOf(
    ...
    const val STAFF_TITLE = "The Supervisor's senior staff"
    const val STAFF_LEDE =
